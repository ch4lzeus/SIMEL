<nav class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="alumno.jsp">
  ...
  <ul class="nav flex-column">
    <li class="nav-item ${param.seccion == 'misCursos' ? 'active' : ''}">
      <a class="nav-link" href="alumno.jsp?seccion=misCursos">
        <i class="fas fa-book-open"></i>
        <span>Mis Cursos</span>
      </a>
    </li>
    <li class="nav-item ${param.seccion == 'misNotas' ? 'active' : ''}">
      <a class="nav-link" href="alumno.jsp?seccion=misNotas">
        <i class="fas fa-clipboard-list"></i>
        <span>Mis Notas</span>
      </a>
    </li>
    <li class="nav-item ${param.seccion == 'logros' ? 'active' : ''}">
      <a class="nav-link" href="alumno.jsp?seccion=logros">
        <i class="fas fa-award"></i>
        <span>Logros</span>
      </a>
    </li>
    <li class="nav-item ${param.seccion == 'canjes' ? 'active' : ''}">
      <a class="nav-link" href="alumno.jsp?seccion=canjes">
        <i class="fas fa-gift"></i>
        <span>Canjes</span>
      </a>
    </li>
    <li class="nav-item ${param.seccion == 'retos' ? 'active' : ''}">
      <a class="nav-link" href="alumno.jsp?seccion=retos">
